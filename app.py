...
lineaccesstoken = 'QVUfZhX312KZAyHF3lzA4AgM4GtC9pRZMXaT5CrGnmssn8++l52NmsN1KyL1muC4por6AS0iH+WelqaApnxJwz7dEOqGt5+r7qGZQ6j25Uu3TGb5FBHL0E17xAS4EVzQfpx+I4xvys7ZrFMqQ3ewLAdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี" :
            ...
            url = "https://covid19.ddc.moph.go.th/api/Cases/today-cases-all%22"
            response = requests.get(url)
            response = response.json()
            replyObj = TextSendMessage(text=str(response))
            line_bot_api.reply_message(rtoken, replyObj)
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/cefa3e2e-6288-417e-a3df-58994147b76c"
